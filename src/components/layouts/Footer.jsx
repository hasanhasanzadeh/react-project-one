                            ...
                            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                                <div>
                                    ...
                                    <ul className="text-gray-600 dark:text-gray-400">
                                        ...
                                        <li>
                                            <a href="https://tailwindcss.com/" className="hover:underline">Tailwind
                                                CSS</a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul className="text-gray-600 dark:text-gray-400">
                                        ...
                                        <li>
                                            <a href="https://discord.gg/4eeurUVvTy"
                                               className="hover:underline">Discord</a>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul className="text-gray-600 dark:text-gray-400">
                                        ...
                                        <li>
                                            <a href="https://flowbite.com" className="hover:underline">Terms &amp; Conditions</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a
                href="https://flowbite.com" className="hover:underline">Flowbite™</a>. All Rights Reserved.
                            ...
                            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                                <a href="https://flowbite.com" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
