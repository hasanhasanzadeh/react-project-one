          ...
          <div>
              <div id="alert-1"
                  ...
                  <div className="ms-3 text-sm font-medium">
                      A simple info alert with an <a href="https://flowbite.com"
                                                     className="font-semibold underline hover:no-underline">example
                  ...
                  <button type="button"
                          ...
                          data-dismiss-target="https://flowbite.comalert-1" aria-label="Close">
              ...
              <div id="alert-2"
                  ...
                  <button type="button"
                          ...
                          data-dismiss-target="https://flowbite.comalert-2" aria-label="Close">
                      <span className="sr-only">Close</span>
                      <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                           viewBox="0 0 14 14">
                          <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
              ...
              <div id="alert-3"
                  ...
                  <button type="button"
                          ...
                          data-dismiss-target="https://flowbite.comalert-3" aria-label="Close">
                      <span className="sr-only">Close</span>
                      <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                           viewBox="0 0 14 14">
                          <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
              ...
              <div id="alert-4"
                  ...
                  <button type="button"
                          ...
                          data-dismiss-target="https://flowbite.comalert-4" aria-label="Close">
                      <span className="sr-only">Close</span>
                      <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                           viewBox="0 0 14 14">
                          <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
              ...
              <div id="alert-5" className="flex items-center p-4 rounded-lg bg-gray-50 dark:bg-gray-800" role="alert">
                  <svg className="flex-shrink-0 w-4 h-4 dark:text-gray-300" aria-hidden="true"
                  ...
                  <div className="ms-3 text-sm font-medium text-gray-800 dark:text-gray-300">
                      A simple dark alert with an <a href="https://flowbite.com"
                                                     className="font-semibold underline hover:no-underline">example
                      link</a>. Give it a click if you like.
                  </div>
                  <button type="button"
                          ...
                          data-dismiss-target="https://flowbite.comalert-5" aria-label="Close">
